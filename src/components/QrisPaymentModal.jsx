        ...
        >
          ...
          <div className="p-4 space-y-3.5 overflow-y-auto no-scrollbar bg-slate-50/50">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-2.5 flex items-center justify-between text-xs font-bold text-slate-700 shadow-xs">
              ...
              <span className="flex items-center gap-1 bg-slate-100 px-2.5 py-1 rounded-xl border border-slate-300 text-slate-900 font-black">
            ...
            <div className="bg-white border border-slate-300 rounded-2xl p-3.5 space-y-2 text-center shadow-xs">
              <div className="flex items-center justify-center gap-1.5 text-[10px] font-black text-slate-900 uppercase tracking-wider">
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full bg-slate-100 text-center font-black text-xl text-slate-900 py-2.5 px-3 rounded-xl border border-slate-300 outline-none cursor-not-allowed select-all font-display"
                />
                <button
                  type="button"
                  onClick={handleCopyNominal}
                  className="absolute right-2 p-1.5 bg-white border border-slate-300 hover:bg-slate-100 text-slate-900 rounded-lg text-[10px] font-bold flex items-center gap-1 shadow-xs transition-colors"
            ...
            <div className="bg-white p-3.5 rounded-2xl border border-slate-200 space-y-3 shadow-xs text-center">
              <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                ...
                <span className="text-[9px] bg-slate-900 text-white font-black px-2 py-0.5 rounded-full">Kebab Hikmal</span>
              </div>
          ...
          {/* Action Footer - Live 5-Minute Payment Timer CTA */}
          <div className="p-4 bg-white border-t border-slate-100 shrink-0">
            <button
              onClick={handleConfirmPaid}
              className={`w-full text-white font-black text-xs sm:text-sm py-3.5 rounded-2xl flex items-center justify-between px-5 active:scale-[0.98] transition-all shadow-lg ${timeLeft < 60
            ...
            >
              ...
              <span className="bg-black/20 font-mono px-3 py-1 rounded-xl text-white font-black text-sm">
                {formatTime(timeLeft)}
              </span>
            </button>
          </div>
